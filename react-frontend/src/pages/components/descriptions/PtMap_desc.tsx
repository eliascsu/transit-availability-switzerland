export default function PtMap_desc() {
    return (
        <div id="pt-map-description">
                ...
                <p id="info1">Switzerlands public transport system is regarded as one
                    of the best in the world. Yet, more than half of commuters
                    still drive to work. 23.3% of citizens choose to use their
                    cars because they have no alternative <a href="https://www.are.admin.ch/are/de/home/medien-und-publikationen/publikationen/verkehr/modalsplit-personenverkehr-schweiz.html" style={{color: "#49BFC1"}}>(Modalsplit ARE 2015)</a>.
                    Our calculations show that only 12.3% of swiss people are not served within reasonable distance of public transit, with the average distance to a public transit stop being ~340 meters <a href="https://www.bfs.admin.ch/bfs/en/home/statistics/sustainable-development/monet-2030/indicators/distance-nearest-public-transport-stop.html" style={{color: "#49BFC1"}}>(2021, bfs)</a>.
                    ...
                    This can be done by adding new, more frequent lines and connecting
                    the country side to better the accessibility of public transportation.
                    On the following map the current coverage of
                    public transportation is shown.
                </p>
                ...
                <p id="info2">With the current issue of climate change, Switzerland is trying to
                    ...
                    of Switzerlands CO2 emissions <a href="https://www.swissinfo.ch/eng/swiss-co2-emissions--small-country--big-footprint/45810036" style={{color: "#49BFC1"}}>(swissinfo)</a>.
    ...
    return (
        <div id="pt-map-description">
            ...
            <h2 id="title3">Quick Facts</h2>
            <p id="info3">Length: Rail 5443, Bus/Tram 21190, Other 1551
            Number of stops: Rail 1772, Bus/Tram 23080, Other 337
            </p>
        </div>
    )
    */
